...
//			
//			EntityMethods.save(new Citta("Seregno", 20831));
//			EntityMethods.save(new Citta("Desio", 20833));
//			EntityMethods.save(new Citta("Lissone", 20838));
//			EntityMethods.save(new Citta("Muggiò", 20841));
//			
//			Set<Citta> tappe=new HashSet<Citta>();
//			tappe.add(EntityMethods.getById(1, Citta.class));
//			tappe.add(EntityMethods.getById(2, Citta.class));
//			tappe.add(EntityMethods.getById(3, Citta.class));
//			tappe.add(EntityMethods.getById(4, Citta.class));
//			
//			EntityMethods.save(new Tratta(tappe, LocalTime.of(1, 12)));
			
//			EntityMethods.save(new Mezzo(TipoMezzo.AUTOBUS, Stato.IN_SERVIZIO, EntityMethods.getById(1, Tratta.class)));
			
//			EntityMethods.save(new Abbonamento(LocalDate.of(2023, 6, 17), Periodicita.MENSILE, EntityMethods.getById(8, Venditore.class), EntityMethods.getById(1, Tratta.class)));
//			EntityMethods.getById(1, Venditore.class);
//			EntityMethods.save(new Biglietto(LocalDate.now(), EntityMethods.getById(7, Venditore.class), EntityMethods.getById(1, Tratta.class), EntityMethods.getById(1, Mezzo.class)));
//			EntityMethods.save(new Biglietto(LocalDate.of(2022, 8, 22), EntityMethods.getById(7, Venditore.class), EntityMethods.getById(1, Tratta.class),EntityMethods.getById(1, Mezzo.class)));
//			EntityMethods.save(new Biglietto(LocalDate.of(2023, 6, 17), EntityMethods.getById(8, Venditore.class), EntityMethods.getById(1, Tratta.class),EntityMethods.getById(1, Mezzo.class)));
//			EntityMethods.getUserWithCard().forEach(u -> System.out.println(u));
//			System.out.println(EntityMethods.validitaAbbonamento(5l));
//			EntityMethods.getTicketVenduti(LocalDate.of(2023, 6, 1), LocalDate.of(2023, 7, 21))
//			.forEach(u -> System.out.println("Id venditore: "+u[0]+"; Ticket venduti: "+ u[1]));
