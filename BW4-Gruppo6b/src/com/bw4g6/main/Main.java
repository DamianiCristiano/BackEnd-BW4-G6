...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//EntityMethods.save(new Biglietto(LocalDate.now(), EntityMethods.getById(1, Venditore.class), EntityMethods.getById(1, Tratta.class)));
			//EntityMethods.save(new Biglietto(LocalDate.of(2022, 8, 22), EntityMethods.getById(1, Venditore.class), EntityMethods.getById(1, Tratta.class)));
			//EntityMethods.save(new Biglietto(LocalDate.of(2023, 6, 17), EntityMethods.getById(1, Venditore.class), EntityMethods.getById(1, Tratta.class)));
